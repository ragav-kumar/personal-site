...
<script> wpThemeClient.start("ws", "127.0.0.1", "8090"); </script>
    ...
    <meta charset="utf-8">
    <link rel="shortcut icon" href="/app/themes/rkain-theme/favicon.ico">
    ...
    <!--
        ...
        Notice the use of "php echo $TEMPLATE_PATH;" and /app/themes/rkain-theme in the tags above.
        Both will be replaced with the URL of the `public` folder during the build (/app/themes/rkain-theme) or
        at render time (php echo $TEMPLATE_PATH;)
        Only files inside the `public` folder can be referenced like this.

        Unlike "/favicon.ico" or "favicon.ico", "/app/themes/rkain-theme/favicon.ico" will
